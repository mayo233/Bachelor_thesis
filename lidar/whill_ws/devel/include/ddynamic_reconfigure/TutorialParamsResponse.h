...
bool operator==(const ::ddynamic_reconfigure::TutorialParamsResponse_<ContainerAllocator1> & lhs, const ::ddynamic_reconfigure::TutorialParamsResponse_<ContainerAllocator2> & rhs)
{
  return lhs.int_param == rhs.int_param &&
    lhs.double_param == rhs.double_param &&
    lhs.str_param == rhs.str_param &&
    lhs.bool_param == rhs.bool_param &&
    lhs.enum_param == rhs.enum_param;
}
